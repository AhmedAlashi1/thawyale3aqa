...
var dataTable = $('#table_view').DataTable({
    ...
    "serverSide": true,
    "ajax": {
        url: urls.get_data_url+'?user_id='+user_id, // json datasource
    },
    "columns": [
        ...
        {"data": function (row, type, val, meta) {
            if (row.region_data){
                return row.region_data.title_ar;
            }else{
                return '';
            }
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data[0] == true) {
                ...
                $(form1).find('input[name=user_id]').val(data[2].user_id);
                $(form1).find('input[name=lng]').val(data[2].lng);
                $(form1).find('input[name=lat]').val(data[2].lat);
                $(form1).find('input[name=address]').val(data[2].address);
                $(form1).find('input[name=flat]').val(data[2].flat);
                $(form1).find('input[name=floor]').val(data[2].floor);
                $(form1).find('input[name=governate]').val(data[2].governate);
                $(form1).find('input[name=city]').val(data[2].city);
                $(form1).find('input[name=block]').val(data[2].block);
                $(form1).find('input[name=street]').val(data[2].street);
