    ...
    $.ajax({
        ...
        success: function (data) {
            if (data[0] == true) {
                ...
                $(form1).find('input[name=time_from]').val(data[2].time_from);
                $(form1).find('input[name=time_to]').val(data[2].time_to);
                if (data[2].sat == 1) {
                    $('.sat_check').bootstrapSwitch('state', true);
                }else{
                    $('.sat_check').bootstrapSwitch('state', false);
                }
                if (data[2].sun == 1) {
                    $('.sun_check').bootstrapSwitch('state', true);
                }else{
                    $('.sun_check').bootstrapSwitch('state', false);
                }

                if (data[2].mon == 1) {
                    $('.mon_check').bootstrapSwitch('state', true);
                }else{
                    $('.mon_check').bootstrapSwitch('state', false);
                }

                if (data[2].tue == 1) {
                    $('.tue_check').bootstrapSwitch('state', true);
                }else{
                    $('.tue_check').bootstrapSwitch('state', false);
                }

                if (data[2].wed == 1) {
                    $('.wed_check').bootstrapSwitch('state', true);
                }else{
                    $('.wed_check').bootstrapSwitch('state', false);
                }

                if (data[2].thu == 1) {
                    $('.thu_check').bootstrapSwitch('state', true);
                }else{
                    $('.thu_check').bootstrapSwitch('state', false);
                }

                if (data[2].fri == 1) {
                    $('.fri_check').bootstrapSwitch('state', true);
                }else{
                    $('.fri_check').bootstrapSwitch('state', false);
                }
