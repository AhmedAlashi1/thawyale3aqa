...
Route::group(
    ...
    Route::controller(AdvertisementsController::class)->group(function () {
        ...
        Route::post('advertisements/update-category' , 'updateCat')->name('advertisements.updateCat');
