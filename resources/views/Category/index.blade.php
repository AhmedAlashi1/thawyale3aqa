...
{{--                                </div>--}}
                                ...
                                <div class="form-group col-md-6">
                                    <label class="ckbox">
                                        <input type="checkbox" class="mb-2" name="individuals"  value="1">
                                        <span> {{ trans('category.Individuals') }}</span>
                                    </label>
                                </div>

                                <div class="form-group col-md-6">
                                    <label class="ckbox">
                                        <input type="checkbox" class="mb-2" name="business" value="1">
                                        <span>{{ trans('category.Business') }}</span>
                                    </label>
                                </div>

{{--                                <div class="form-group col-md-6">--}}
{{--                                    <label class="ckbox">--}}
{{--                                        <input type="checkbox" class="mb-2" name="individuals_and_business"  value="1">--}}
{{--                                        <span> {{ trans('category.max') }}</span>--}}
{{--                                    </label>--}}
{{--                                </div>--}}
                            </div>
                            <div class="modal-footer">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="formeditadmin" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="ckbox">
                                        <input type="checkbox" class="mb-2" name="individuals" id="individuals"  value="1">
                                        <span> {{ trans('category.Individuals') }}</span>
                                    </label>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label class="ckbox">
                                        <input type="checkbox" class="mb-2" name="business" id="business" value="1">
                                        <span>{{ trans('category.Business') }}</span>
                                    </label>
                                </div>
...
{{--                                <div class="form-group col-md-6">--}}
{{--                                    <label class="ckbox">--}}
{{--                                        <input type="checkbox" class="mb-2" name="individuals_and_business"  id="individuals_and_business" value="1">--}}
{{--                                        <span> {{ trans('category.max') }}</span>--}}
{{--                                    </label>--}}
{{--                                </div>--}}
                                <div class="form-group col-md-12">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="window.location.reload()">{{ trans('category.Close') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        if (response.data.individuals == '1') {
                            $('#individuals').attr('checked', true);
                        }
                        if (response.data.business == '1') {
                            $('#business').attr('checked', true);
                        }
                        if (response.data.individuals_and_business == '1') {
                            $('#individuals_and_business').attr('checked', true);
                        }
                    }
                }
            });
